...
const MusicPlayer: React.FC<MusicPlayerProps> = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-muted/90 backdrop-blur-lg p-4 border-t border-white/10">
      {currentSong && (
        <>
          <audio
            ref={audioRef}
          ...
          <div className="w-full mb-4">
            <input
              ...
              value={currentTime}
              onChange={handleSeek}
              className="w-full h-2 rounded-lg bg-gray-700 appearance-none cursor-pointer accent-primary"
            />
